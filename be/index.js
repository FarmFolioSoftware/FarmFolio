...
app.post("/register", async (req, res) => {
	...
	try {
		...
		await dbConnection.query("INSERT INTO tblUserRole (userID, roleName) VALUE (?, CASE WHEN ? = 'Farm Owner' THEN 1 WHEN ? = 'Employee' THEN 2 END);", [targetUserID, strRole, strRole]);
