        ...
        <div className="d-flex my-4 align-items-center">
          <div className="col-2">
            <div className="card bg-dark col-11 mx-auto p-3">
              ...
              <button className="btn btn-outline-light col-8 offset-2 clockButton mb-3" onClick={this.clock}>Clock In</button>
              <button className="btn btn-outline-light col-8 offset-2 clockButton" onClick={this.clock}>Clock Out</button>
            </div>
          </div>
          <div className="col-7">
            <Tabs>
